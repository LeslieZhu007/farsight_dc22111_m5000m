...
{
    unregister_chrdev(240,"m74hc595");
    device_destroy(cls,MKDEV(240,0));
    class_destroy(cls);

    unregister_chrdev(241,"m74hc595");
    device_destroy(cls,MKDEV(241,0));
    class_destroy(cls);

    unregister_chrdev(242,"m74hc595");
    device_destroy(cls,MKDEV(242,0));
    class_destroy(cls);
    printk("%s:%d\n",__FILE__,__LINE__);
    return 0;
}
