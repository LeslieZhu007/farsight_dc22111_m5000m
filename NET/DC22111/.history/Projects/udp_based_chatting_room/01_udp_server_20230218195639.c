        ...
        while (1)
        {
            ...
            switch (protocol.type)
            {
                case 'L':
                    ...
                    {
                        printf("进入while循环,%d\n",__LINE__);
                        printf("p2->cin.sin_addr.s_addr = %d\n",p2->cin.sin_addr.s_addr);
                        printf("cin.sin_addr.s_addr = %d\n",cin.sin_addr.s_addr);
                        if (p2->cin.sin_addr.s_addr!=cin.sin_addr.s_addr)
                        {
                ...
                case 'C':
                    ...
                    while (NULL!=p3)
                    {
                        if (p3->cin.sin_addr.s_addr!=cin.sin_addr.s_addr)
                        {
                ...
                case 'Q':
                   ...
                   linklist p4 = L->next;
                    while (NULL!=p4)
                    {
                        if (p4->cin.sin_addr.s_addr!=cin.sin_addr.s_addr)
                        {
