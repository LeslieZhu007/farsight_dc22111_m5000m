...
#define USERINFO_UPDATE_FORMAT "update usrinfo set staffno =%d,usertype = %d,name = \"%s\",passwd = \"%s\",age = %d ,phone = \"%s\",addr = \"%s\",work = \"%s\",date = \"%s\",level = %d ,salary = %lf where name = '%s'"
#define USER_INSERT_FORMAT "insert into user values(\"%s\",%d)"
#define USRINFO_INSERT_FORMAT "insert into usrinfo  values(%d,%d,\"%s\",\"%s\",%d,\"%s\",\"%s\",\"%s\",\"%s\",%d, %lf)"
#define USRINFO_DELETE_FORMAT "delete from usrinfo where name = \"%s\""
#define USER_DELETE_FORMAT "delete from user where name = \"%s\""
...
#define LOGGED_IN 1
#define LOGGED_OFF 0
#define USER_UPDATE_FAIL "用户更新失败"
#define USER_UPDATE_SUCCESS "用户更新成功"
#define ADMIN_UPDATE_FAIL "管理员更新失败"
#define ADMIN_UPDATE_SUCCESS "管理员更新成功"
#define USER_QUERY_SUCCESS "用户查询成功"
#define USER_QUERY_FAIL "用户查询失败"
#define ADMIN_QUERY_SUCCESS "管理员查询成功"
#define ADMIN_QUERY_FAIL "管理员查询失败"
#define ADMIN_ADDUSER_SUCCESS "管理员添加用户成功"
#define ADMIN_ADDUSER_FAIL "管理员添加用户失败"
#define ADMIN_DELUSER_SUCCESS "管理员删除用户成功"
#define ADMIN_DELUSER_FAIL "管理员删除用户失败"
#define ADMIN_HISTORY_FAIL "管理员历史记录查询失败"
#define ADMIN_HISTORY_SUCCESS "管理员历史记录查询成功"
#define QUIT_SUCCESS "用户退出成功"
#define QUIT_FAIL "用户退出失败"
