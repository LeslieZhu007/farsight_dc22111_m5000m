...
#define USERINFO_UPDATE_FORMAT "update usrinfo set staffno =%d,usertype = %d,name = \"%s\",passwd = \"%s\",age = %d ,phone = \"%s\",addr = \"%s\",work = \"%s\",date = \"%s\",level = %d ,salary = %f where name = '%s'"
